...
/**
 * This scoring function aggregates impact factors that are used in calculating security risk
 * introduced by an open source project. This is based on the following factors:
 *
 * <ul>
 *   <li>{@link DataConfidentialityRiskImpactFactor}
 *   <li>{@link ConfidentialityRiskImpactFactor}
 *   <li>{@link IntegrityRiskImpactFactor}
 *   <li>{@link AvailabilityRiskImpactFactor}
 * </ul>
 */
public class RiskImpactScore extends WeightedCompositeScore {
  ...
  /**
   * This scoring function outputs am impact factor for security risk of open source project. The
   * factor is based on potential integrity impact in case of a security problem in an open source
   * project.
   */
  ...
  /**
   * This scoring function outputs am impact factor for security risk of open source project. The
   * factor is based on potential availability impact in case of a security problem in an open
   * source project.
   */
