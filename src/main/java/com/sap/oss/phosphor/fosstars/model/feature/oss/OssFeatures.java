...
public class OssFeatures {
  ...
  /**
   * Shows if an open-source project has a dedicated security team. It may be a team which receives
   * vulnerability reports from external researchers, and coordinates patching and disclosures.
   */
  public static final Feature<Boolean> HAS_SECURITY_TEAM =
      new BooleanFeature("If an open-source project has a security team");

  /**
   * Shows if an open-source project has a security policy which describes how a vulnerability
   * should be reported, how security problems are getting fixed, etc.
   *
   * @see <a
  ...
  /**
   * Shows if an open-source project uses <a
  ...
  /**
   * Shows if an open-source project is added to <a
   * href="https://github.com/google/oss-fuzz">OSS-Fuzz</a> project to be regularly fuzzed.
   */
  ...
  /**
   * Shows if a project uses Dependabot.
   *
   * <p><a href="https://dependabot.com/">Dependabot</a> offers automatic dependency updates. In
   * particular, when Dependabot finds a vulnerability in dependencies, it opens a pull request to
   * update the vulnerable dependency to the safe version.
   */
  public static final Feature<Boolean> USES_DEPENDABOT =
      new BooleanFeature("If a project uses Dependabot");

  /**
   * Shows if an open source project has open pull requests from Dependabot which means that there
   * are dependencies with known vulnerabilities.
   *
   ...
   *
   * <p><a href="https://snyk.io/">Snyk introduction</a> offers
   *
   * <ul>
   *   <li>Static Application Security Testing (SAST)
   *   <li>Automatic dependency updates
   * </ul>
   *
   * <p>In particular for automatic dependency updates, when Snyk finds a vulnerability in
   * dependencies, it opens a pull request to update the vulnerable dependency to the safe version.
   */
  public static final Feature<Boolean> USES_SNYK = new BooleanFeature("If a project uses Snyk");

  /**
   * Shows if an open source project has open pull requests from Snyk which means that there are
  ...
  public static final Feature<Date> PROJECT_START_DATE = new DateFeature("When a project started");

  /**
   * Holds a date of the first commit to the source repository. It may be used to estimate a moment
   ...
   *
   * @see <a
   *     href="https://docs.github.com/en/free-pro-team@latest/github/finding-security-vulnerabilities-and-errors-in-your-code/enabling-code-scanning-for-a-repository">Enabling
   ...
   *
   * @see <a href="https://github.com/PyCQA/bandit#usage">Trigger Bandit code scanning for a
   *     repository</a>
   */
   ...
   *
   * @see <a href="https://github.com/PyCQA/bandit#usage">Trigger Bandit code scanning job on every
   *     PR of a project</a>
   */
   ...
   *
   * @see <a href="https://github.com/securego/gosec#gosec---golang-security-checker">Trigger GoSec
   *     code scanning for a repository</a>
   */
   ...
   *
   * @see <a href="https://github.com/securego/gosec#usage">Trigger GoSec code scanning job on every
   *     PR of a project</a>
   */
   ...
   *
   * @see <a href="https://github.com/securego/gosec#usage">Trigger GoSec code scanning for a
   *     repository with rules</a>
   */
   ...
   *
   * @see <a href="https://owasp.org/www-project-enterprise-security-api/">OWASP Enterprise Security
   *     API (ESAPI)</a>
   */
  ...
  public static final BooleanFeature HAS_LICENSE = new BooleanFeature("If a project has a license");
   ...
   *
   * @see <a
   *     href="https://docs.github.com/en/github/managing-security-vulnerabilities/about-alerts-for-vulnerable-dependencies">About
   *     alerts for vulnerable dependencies</a>
   */
