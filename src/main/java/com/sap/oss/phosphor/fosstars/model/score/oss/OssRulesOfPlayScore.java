...
/**
 * This score shows how well an open source project follows certain rules. The score is based on a
 * set of features that represent rules of play for an open source project.
 */
public class OssRulesOfPlayScore extends FeatureBasedScore {
  ...
  public static final Set<Feature<Boolean>> RECOMMENDED_FALSE =
      Collections.unmodifiableSet(setOf(HAS_UNRESOLVED_VULNERABILITY_ALERTS, INCOMPLETE_README));
