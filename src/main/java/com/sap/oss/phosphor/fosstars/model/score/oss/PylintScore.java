...
/**
 * The score shows if and how a project uses static analysis with Pylint. The score is based on the
 * following features.
 *
 * <ul>
...
public class PylintScore extends FeatureBasedScore {
   ...
   *
   * @see <a href="https://pylint.pycqa.org/en/latest/index.html">Pylint overview</a>
   */
  ...
  public ScoreValue calculate(Value<?>... values) {
    Value<Boolean> usesPylintChecks =
        findValue(
            values,
            USES_PYLINT_SCAN_CHECKS,
            "Hey! You have to tell me if the project uses Pylint checks!");
    Value<Boolean> runsPylintScans =
        findValue(
            values,
            RUNS_PYLINT_SCANS,
    ...
    ScoreValue scoreValue = scoreValue(MIN, usesPylintChecks, runsPylintScans, languages);
