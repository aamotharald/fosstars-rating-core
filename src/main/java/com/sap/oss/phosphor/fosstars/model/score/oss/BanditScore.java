...
/**
 * The score shows if and how a project uses static analysis with Bandit. The score is based on the
 * following features.
 *
 * <ul>
...
public class BanditScore extends FeatureBasedScore {
   ...
   *
   * @see <a
   *     href="https://bandit.readthedocs.io/en/latest/#welcome-to-bandit-s-developer-documentation">Bandit
   *     overview</a>
   */
  ...
  public ScoreValue calculate(Value<?>... values) {
    Value<Boolean> usesBanditChecks =
        findValue(
            values,
            USES_BANDIT_SCAN_CHECKS,
            "Hey! You have to tell me if the project uses Bandit checks!");
    Value<Boolean> runsBanditScans =
        findValue(
            values,
            RUNS_BANDIT_SCANS,
    ...
    ScoreValue scoreValue = scoreValue(MIN, usesBanditChecks, runsBanditScans, languages);
