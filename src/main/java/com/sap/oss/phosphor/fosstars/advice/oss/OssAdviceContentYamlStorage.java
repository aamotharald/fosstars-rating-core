...
/**
 * The class provides advice for {@link
 * com.sap.oss.phosphor.fosstars.model.feature.oss.OssFeatures}. It is based on {@link
 * AdviceContentYamlStorage}. The class requires a {@link OssAdviceContext} that helps with creating
 * detailed advice for open-source projects.
 */
public class OssAdviceContentYamlStorage {
  ...
  public abstract static class OssAdviceContext implements AdviceContext {
    ...
    public static final OssAdviceContext EMPTY_OSS_CONTEXT =
