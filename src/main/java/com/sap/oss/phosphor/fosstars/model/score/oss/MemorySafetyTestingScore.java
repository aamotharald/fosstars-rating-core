...
/**
 * The score shows how an open-source project tests for memory-corruption issues such as buffer
 * overflows, use-after-free and so on.
 *
...
public class MemorySafetyTestingScore extends FeatureBasedScore {
  ...
  MemorySafetyTestingScore() {
    super(
        "How a project tests for memory-safety issues",
        LANGUAGES,
  ...
  public ScoreValue calculate(Value<?>... values) {
    ...
    ScoreValue scoreValue =
        scoreValue(
            MIN,
            languages,
            usesAddressSanitizer,
            usesMemorySanitizer,
            usesUndefinedBehaviorSanitizer);
