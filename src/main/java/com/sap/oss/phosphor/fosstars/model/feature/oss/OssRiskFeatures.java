...
/**
 * The class contains features that are used in the security risk calculator for open source
 * projects.
 */
public class OssRiskFeatures {

  /**
   * Shows how many components such as applications, services, products, etc. use an open source
   * project.
   */
  ...
  public static final EnumFeature<DataConfidentialityType> DATA_CONFIDENTIALITY =
      new EnumFeature<>(
          DataConfidentialityType.class,
          "Confidentiality of data that an open source project likely processes");

  /**
   * Describes potential impact to confidentiality of data in case of a security problem in an open
   * source project.
   */
  public static final EnumFeature<Impact> CONFIDENTIALITY_IMPACT =
      new EnumFeature<>(
          Impact.class, "Potential impact to confidentiality in case of a security problem");

  /**
   * Describes potential impact to integrity of data in case of a security problem in an open source
   * project.
   */
  public static final EnumFeature<Impact> INTEGRITY_IMPACT =
      new EnumFeature<>(
          Impact.class, "Potential impact to integrity in case of a security problem");

  /**
   * Describes potential impact to availability in case of a security problem in an open source
   * project.
   */
  public static final EnumFeature<Impact> AVAILABILITY_IMPACT =
      new EnumFeature<>(
          Impact.class, "Potential impact to availability in case of a security problem");
}
